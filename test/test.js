...
var oldPlugin = require('../index');
var plugin = require('../index-new.js');
...
var oldTest = function (input, output, opts) {
    expect(postcss([oldPlugin(opts), postcssCustomProps]).process(input).css).to.eql(output);
};

describe('postcss-for', function () {

    // it('it iterates from and to', function () {
    //     oldTest('@for $i from 1 to 2 { .b-$i { width: $(i)px; } }',
    //          '.b-1 {\n    width: 1px\n}\n.b-2 {\n    width: 2px\n}');
    // });
